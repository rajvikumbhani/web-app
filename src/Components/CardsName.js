...
export default function CardName(props) {
    ...
    function showPosition(position) {
        ...
        currentWeatherUsingCityName(lati, long);
        forcastWeatherUsingCityName(lati, long);
    } 

    function currentWeatherUsingCityName(lati, long) {
        const options = {
            method: 'GET',
            url: `https://weatherapi-com.p.rapidapi.com/current.json?q=${lati},${long}`,
            headers: {
    ...
    function forcastWeatherUsingCityName(lati, long) {
        const options = {
            method: 'GET',
            url: 'https://weatherapi-com.p.rapidapi.com/forecast.json',
            params: { q: `${lati},${long}`, days: '3' },
            headers: {
                'X-RapidAPI-Key': '1ffe563f75msha16936234a75061p1c62afjsn3971df74211e',
                'X-RapidAPI-Host': 'weatherapi-com.p.rapidapi.com'
            }
